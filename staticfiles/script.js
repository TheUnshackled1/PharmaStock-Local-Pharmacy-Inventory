document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form input focus
    const formInputs = document.querySelectorAll('.form-control, input[type="text"], input[type="password"], input[type="email"], input[type="number"], textarea');
